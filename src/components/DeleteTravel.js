...
import { getAllTravels, getOrdersByTravelId, deleteTravel } from '../redux/actions';
...
const mapDispatchToProps = (dispatch, ownProps) => ({
    ...
    deleteTravel: (travelId) => dispatch(deleteTravel(travelId)),
})


function DeleteTravel(props) {
    ...
    //פונקציה שתמחק את הנסיעה הרצויה 
    const deleteTravel = (e) => {
        e.preventDefault();
        //מחיקת הנסיעה
        props.deleteTravel(bold);
    }
    ...
    return (
        <div>
            ...
            {/* כפתור מחיקת הנסיעה ועדכון הנרשמים שהנסיעה בוטלה עקב סיבה כלשהיא */}
